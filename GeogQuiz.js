...
import { quizData } from './GeogQuizData';
import * as SQLite from 'expo-sqlite';
import { LinearGradient } from 'expo-linear-gradient';

const db = SQLite.openDatabase('GeographyQuizDB.db');

export default function GeogQuiz() {
    ...
    const saveScore = () => {
        ...
        db.transaction(tx => {
            tx.executeSql('insert into highScoreGeo (name, score) values (?, ?);', [name, score], (_, result) => {
    ...
    return (
        <View style={styles.container}>
            ...
            />
            <Image style={styles.image} source={require('./images/Geography.png')} />
